...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($result->num_rows > 0) {
        ...
        $error_message = "No ticket found with this ID code.";
    }
}
?>
    ...
    <div class="content">
        ...
        <form method="POST" action="">
            <label for="ticket_id">Enter your ticket code:</label>
            <input type="number" id="ticket_id" name="ticket_id" required>
            <button type="submit">Check</button>
        </form>

        <?php if (isset($ticket)): ?>
        <h3>Information of ticket</h3>
        <table>
            <tr>
                <th>Information</th>
                <th>Detail</th>
            ...
            <tr>
                <td>Tour ID</td>
                <td><?= htmlspecialchars($ticket['TourID']); ?></td>
            </tr>
            <tr>
                <td>Traveller ID</td>
                <td><?= htmlspecialchars($ticket['Traveller_ID']); ?></td>
            </tr>
            <tr>
                <td>Date booked</td>
                <td><?= htmlspecialchars($ticket['Date_booking']); ?></td>
            </tr>
            <tr>
                <td>Payed</td>
                <td><?= ($ticket['Payed'] == 1) ? 'Yes' : 'No'; ?></td>
            </tr>
            <tr>
                <td>Number of tickets</td>
                <td><?= htmlspecialchars($ticket['Max_Tickets']); ?></td>
            </tr>
            <tr>
                <td>Total Money</td>
        ...
        <a href="T_tour_detail.php?TourID=<?php echo htmlspecialchars($ticket['TourID']); ?>"
