                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="userDropdown">
                            ...
                            <a class="dropdown-item" href="cart.php">Checkout</a>
                    ...
                    <div class="tour-results">
                        ...
                        <div class="tour-grid">
                            ...
                            <div class="tour-item">
                                ...
                                <a href="tour_detail.php?TourID=<?php echo urlencode($row['TourID']); ?>"
...
?>
        ...
        <div class="container">
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo '<p><strong>Booked:</strong> ' . htmlspecialchars($row['Tickets_Booked']) . ' / ' . htmlspecialchars($row['Max_Tickets']) . ' ticket</p>';
                    echo '<p><strong>Date:</strong> ' . htmlspecialchars($row['Date_start']) . ' '. '    To    ' .' '. htmlspecialchars($row['Date_end']) . '</p>';
                    ...
                    echo '<button onclick="window.location.href=\'tour_detail.php?TourID=' . $row['TourID'] . '\'">View Detail</button>';
                    echo '</div>';
    ...
    <section class="ftco-section ftco-services img" style="background-image: url(images/bg_5.jpg);">
        <div class="overlay"></div>
        <div class="container py-lg-5">
            <div class="row py-lg-5">
                <div class="col-md-12 d-flex align-items-center justify-content-center">
                    <a href="https://vimeo.com/45830194"
                        class="icon-play popup-vimeo d-flex align-items-center justify-content-center mb-5">
    ...
    <section class="ftco-section ftco-services ftco-no-pt img">
        <div class="container">
            <div class="row d-flex">
                <div class="col-md-12 about-intro">
                    <div class="row">
                        <div class="col-md-6 d-flex align-items-stretch">
                            <div class="image-container d-flex w-100 align-items-center justify-content-center"
                                style="background-image:url(images/about-2.jpg);">
                            </div>
                        </div>
                        <div class="col-md-6 pl-lg-5 py-4">
                            <div class="row justify-content-start pb-4">
                                <div class="col-md-12 heading-section ftco-animate">
                                    <span class="subheading">Our Story</span>
                                    <h2 class="mb-4">Create Unforgettable Experiences with Us</h2>
                                    <p>Hidden away, beyond the distant mountains, lies a place called Bookmarksgrove,
                                        where the language flows like an ocean of possibilities.</p>
                                    <p><a href="#" class="btn btn-success">Join Our Journey</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
