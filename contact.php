...
<body>
    ...
    <!-- Contact Section -->
    <section class="ftco-section ftco-contact bg-light">
        <div class="container">
                ...
                <div class="col-md-6">
                    <div class="ftco-footer-widget pt-5 mb-4">
                        ...
                        <ul class="list-unstyled">
                            <li><span class="fa fa-map-marker"></span><span class="text">26, Pham Ngoc Thach, Thi Tran
                                    Tan Hiep, huyen Tan Hiep, tinh Kien Giang, Viet Nam</span></li>
                            <li><a href="#"><span class="fa fa-phone"></span><span class="text">+84522120895</span></a>
                            </li>
                            <li><a href="#"><span class="fa fa-paper-plane"></span><span
