        ...
        <div class="container">
            <div class="row justify-content-center mb-5 pb-3">
                <div class="col-md-7 heading-section text-center">
                    <h2 class="mb-4">Latest Travel Blogs</h2>
                    <p>Embark on a journey through stories and breathtaking destinations.</p>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-4 mb-4">
                    <div class="blog-entry">
                        <img src="images/beach.jpg" alt="Stunning Beaches">
                        <div class="p-4">
                            <h3><a href="#">5 Stunning Beaches You Must Visit</a></h3>
                            <p>Discover the turquoise waters and golden sands of the world’s most beautiful beaches.</p>
                ...
                <div class="col-md-4 mb-4">
                    <div class="blog-entry">
                        <img src="images/moutain.jpeg" alt="Mountains">
                        <div class="p-4">
                            <h3><a href="#">Exploring the Majestic Mountains</a></h3>
                            <p>Experience the serenity of nature and the thrill of adventure in the mountains.</p>
                            <a href="#" class="btn btn-sm">Read More</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-4 mb-4">
                    <div class="blog-entry">
                        <img src="images/guide.jpg" alt="Hanoi Guide">
                        <div class="p-4">
                            <h3><a href="#">A Traveler’s Guide to Hanoi</a></h3>
                            <p>Immerse yourself in the vibrant culture and history of Hanoi.</p>
                            <a href="#" class="btn btn-sm">Read More</a>
                        </div>
                    </div>
                </div>
